...
| [Session Creation Modals](frontend/session-creation-modals.md) | Entry points for launching sessions — NewSessionModal (SSH + local) + WorkdirLauncher + QuickSessionModal | `src/components/modals/NewSessionModal.tsx`, `src/components/modals/QuickSessionModal.tsx`, `src/components/layout/WorkdirLauncher.tsx` |
