...
// Pure grid math lives in a Three-free module so 2D consumers (SceneOverlay)
// can use it without pulling in Three.js. Re-exported so 3D code keeps a single
// import site.
export {
  ROOM_SIZE, ROOM_GAP, ROOM_CELL, ROOM_HALF, ROOM_COLS,
  computeRoomCenter, computeRoomCameraTarget,
} from './roomGrid';
import { ROOM_GAP, ROOM_HALF, ROOM_COLS, computeRoomCenter } from './roomGrid';
